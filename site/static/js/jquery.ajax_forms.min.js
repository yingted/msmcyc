 ...
 */
*!Copyright 2009 Tim Savage<tim.savage@jooceylabs.com>*Licensed under the BSD license(http:**Version:0.2*Requires jQuery 1.2.6+*Docs:http:*/(function($){function log(message){if(window.console){console.debug(message);}}
...
if(opts.add_required_indicators&&fields[name].required){$('label[for='+field[0].id+']',form).after('<span class="required">*</span>');}}}
