...
class MsAwarenessVolunteer(HasRandom):
	...
	locations="Dixie Value Mall","Clarkson GO","Cooksville GO","Meadowvale GO","Port Credit GO","Streetsville GO","No preference",
	location=db.StringProperty(choices=locations,required=True,validator=validator(lambda x:x in locations or x=="Erin Mills Town Centre"))
